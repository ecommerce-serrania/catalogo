...
function activarAnimaciones(){
  ...
  const seleccion = [
    ...
    ".video-marco", ".video-texto", ".marca-celda", ".tarjeta",
    ".manifiesto-intro", ".franja .contenedor", ".cifra"
  ].join(",");
  ...
  registrar(document);
  // Las tarjetas del catálogo se pintan después, con los filtros
  document.addEventListener("cotizacion:cambio", () => registrar(document));
